...
{
    public partial class frm_Nuevo_MF : Form
    {
        //Clases
        ...
        public frm_Nuevo_MF(DataTable dt, string Cantidad)
        {
            InitializeComponent();
            this.dt = dt;
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (dtConfirmacion.Rows.Count == 0)
            {
                if (txtMAC.Text != "")
                {
                    ...
                    ObjProductos._set_MAC(txtMAC.Text, Id, Ids(dtFactura, cbFactura), Codigo);
